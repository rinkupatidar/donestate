...
const HoriSelectListFinancial = ({ dataArr, initialIdx, onClick, layoutId = "layout_bg", value, controlKey, itemClassName, key: _key }: HoriSelectListProps) => {
	...
	useEffect(() => {
		...
		const idx=dataArr.findIndex((val)=> value === val.value)
		setSelectedIdx(idx)
	},[value])
...
export default HoriSelectListFinancial
